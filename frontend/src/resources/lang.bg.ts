...
const lang: HTMLFields = {
  ...
  mainPage: {
    ...
    homegrownHeading: {
      title: 'Homegrown',
      subtitle:
        'Ние обичаме всички наши красиви марки тук в Rexlan, но има специално място в сърцето ни за Българските марки. Улеснихме ви да намерите малко за всяка от тези невероятни марки. Преминете към нашата страница Homegrown, където ви даваме кратка представа какво прави всяка от тези марки толкова специална.'
    }
  },
  footer: {
  ...
  registerPage: {
    ...
    providedDataIsUsedFor:
      'Предоставените данни ще се използват за по-бързо плащане.'
  },
  resetPasswordPage: {
    heading: {
      title: 'Забравена парола',
      subtitle:
        'Ще изпратим временна парола на вашия имейл, за да можете да влезете 😄.'
    },
  ...
  cart: {
    ...
    paymentPage: {
      ...
      developmentWarning:
        'Внимание! В момента плащането не е в пълна функционалност. Всички плащания работят само с "sandbox" профили.',
      toPay: 'Сума за плащане',
      payPalNotSet:
        'За съжаление не можете да завършите поръчката си в момента. API ключът на PayPal не може да бъде намерен.'
    },
  ...
  contactsPage: {
    ...
    forMediaQueries:
      'За медийни запитвания се свържете с email@email.com или намерете своя регионален медиен контакт',
      ...
      myOrders: {
        ...
        ordersTable: {
          ...
          viewOrderModal: {
            ...
            header:
              'Получихме вашата поръчка! Вашият свят е на път да изглежда много по-добре. Ще ви изпратим друг имейл, когато поръчката ви бъде изпратена.',
            orderedProducts: 'Поръчани продукти',
            billingInfo: 'Информация за плащане',
            shippingAddress: 'Адрес за доставка',
            ifYouNeedHelp:
              'Ако имате нужда от помощ за нещо, моля, не се колебайте да ни изпратите имейл :)'
          }
        }
      },
      adminPanel: {
        ...
        editCategories: {
          header: {
            ...
            subtitle:
              'Тук можете да добавяте, премахвате и редактирате категории',
            secondSubtitle:
              'Изтриването на категория ще премахне всички свързани с нея продукти.'
          },
          editCategoriesTableCols: {
            bannerImageCol: 'Изображение на банер',
            nameCol: 'Заглавие'
          }
        },
        editUsers: {
          header: {
            title: 'Редактиране на потребители',
            subtitle:
              'Тук можете да добавяте, премахвате и редактирате потребители'
          },
          editUsersTable: {
            emailCol: 'Имейл',
            nameCol: 'Име'
