      ...
      <section className='d-flex justify-content-center justify-content-lg-between p-4 border-bottom container'>
        ...
        <div>
          {brands.map((brand: IconDefinition, index: number) => (
            <FontAwesomeIcon key={index} className='me-3' icon={brand} />
          ))}
        </div>
      </section>
          ...
          <div className='row mt-3'>
            <div className='col-md-3 col-lg-4 col-xl-3 mx-auto mb-4'>
              ...
              <p>
                ...
                impedit ipsam illum suscipit eaque autem error perspiciatis
                saepe alias itaque iste.
              </p>
            </div>
            ...
            <div className='col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4'>
              ...
              <p>
                <FontAwesomeIcon icon={faHome} className='me-1' /> Rousse,
                Bulgaria
              </p>
              <p>
              ...
              <p>
                <FontAwesomeIcon icon={faPhone} className='me-1' /> + 01 234 567
                88
              </p>
              <p>
                <FontAwesomeIcon icon={faPrint} className='me-1' /> + 01 234 567
                88
              </p>
            </div>
          </div>
